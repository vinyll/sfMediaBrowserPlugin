<div class="icon">
  ...
  <div class="action">
    ...
    <?php endif ?>
    <span class="dimensions"><?php echo link_to('edit', 'sf_media_browser_edit', array('file' => urlencode($file))) ?></span>
    <?php echo link_to('delete', 'sf_media_browser_file_delete', array('file' => urlencode($file)), array('class' => 'delete', 'title' => sprintf('Delete file "%s"', $file->getName()))) ?>
  </div>
</div>
